...
- *<span style="color:#009faf">nldas_prepped</span>* Output from the **<span style="color:DarkOrange">nldas_prep</span>** function (from **StreamLightUtils**)
- *<span style="color:#009faf">modis_prepped</span>* Output from the **<span style="color:DarkOrange">appeears_prep</span>** function (from **StreamLightUtils**)
...
![A schematic of various input parameters](../man/figures/diagram.png)
...
![Measuring stream azimuth](../man/figures/measuring_stream_azimuth.png)
